...
public:
	...
	virtual void Init()
	{
		...
		// Camera
		{
            ...
            pCameraObj->m_pTransform = new Transform( Vector3(0, 1.5, -3), Vector3(20.0, 0.0, 0.0));
		...
		// Object # 1 - Cube (is morphed to sphere)
		{
            ...
            pObject->m_pMaterial	= new MaterialUnlitSimpleChoosable("ShaderMorphingCube", "ShaderUnlitSimple");
		...
		// Object #2 - Cylinder (is twisted)
        {
			Object * pObject = new Object();
			pObject->m_pTransform	= new Transform( Vector3(1.5, 0, 0), Vector3(0, 30, 0) );
            pObject->m_pMesh		= new MeshCylinder(100);
            pObject->m_pMaterial	= new MaterialUnlitSimpleChoosable("ShaderMorphingCylinder", "ShaderUnlitSimple");
