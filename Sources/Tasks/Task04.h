...
public:
	...
	virtual void Init()
	{
		...
		// Object - Sphere
		{
            ...
            pObject1->m_pMaterial->reflectiveness = 10.0;
		...
		// Ligth source #2 - Point
		{
			...
			Object * pLightObject = new Object();
            pLightObject->m_pTransform	= new Transform(30,0,-10, 0,0,0, 1,1,1);
			pLightObject->AddComponent(pLight);
        ...
        // Ligth source #3 - Spot
        {
            ...
            pLight->SetAttenuationCoefficient(0.1f);

            Object * pLightObject = new Object();
            pLightObject->m_pTransform	= new Transform(-4,0,0, 0,90,0, 1,1,1);
            pLightObject->AddComponent(pLight);
            pLightObject->AddComponent( new ObjectRotator(0,100,0) );
            scene.AddLight(pLight);
        }
	}
