...
public:
	...
	{
        return Vector4(m_type, static_cast<double>(m_attenuation_coeff),
	...
	*/
    ...
    void SetAttenuationCoefficient(float attencoff)
    {
        m_attenuation_coeff = attencoff;
    }
